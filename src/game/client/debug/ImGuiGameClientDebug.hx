...
import game.client.debug.accessor.render.SAOBiasAccessor;
import game.client.debug.accessor.render.SAOBlurLinearityAccessor;
import game.client.debug.accessor.render.SAOBlurQualityAccessor;
import game.client.debug.accessor.render.SAOBlurRadiusAccessor;
import game.client.debug.accessor.render.SAOIntensityAccessor;
import game.client.debug.accessor.render.SAORadiusAccessor;
import game.client.debug.accessor.render.SAOSamplesAccessor;
import game.client.debug.accessor.render.ShadowPowerAccessor;
import game.client.debug.accessor.render.ShadowSizeAccessor;
import game.client.debug.accessor.render.ShadowBlurQualityAccessor;
import game.client.debug.accessor.render.ShadowBlurRadiusAccessor;
...
class ImGuiGameClientDebug extends ImGuiDebug {
	...
	public function new( parent : Process ) {
		...
		new DragDoubleNode( "zFarK", new ZFarKAccessor(), 0.1, 1.000, 180, cameraHeader );
